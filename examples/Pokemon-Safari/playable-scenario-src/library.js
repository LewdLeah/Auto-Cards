    ...
    */
    ...
    function getDefaultConfigBans() {
        if (typeof DEFAULT_BANNED_TITLES_LIST === "string") {
            ...
            return [
                "North", "East", "South", "West", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December", "Normal", "Fire", "Water", "Electric", "Grass", "Ice", "Fighting", "Poison", "Ground", "Flying", "Psychic", "Bug", "Rock", "Ghost", "Dragon", "Dark", "Steel", "Fairy", "Stellar", "Pokemon", "Poke", "Pokeball", "Pokedex", "Dex", "Trainer", "Gym", "Champion", "Battle", "Box", "Team", "Nature", "Ability", "Move", "Form", "Forme", "Mega", "Dynamax", "Gigantmax", "Terastallization", "Tera", "Hidden"
            ];
        }
    }
